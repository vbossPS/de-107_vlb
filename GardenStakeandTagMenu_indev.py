...
### Key Changes:
#. **Directory Management**: The script ensures the existence of necessary directories at the start and handles the deletion of temporary directories upon exiting the program.
#. **Exit Option Updated**: The main menu's exit option now deletes any temporary directories before exiting, as specified.
#. **Path Management**: Utilizing the `pathlib` module to handle paths in a platform-independent and readable manner.
